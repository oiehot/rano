...
namespace Rano.Tests.Core
{
    public class YieldCacheTests
    {
        ...
        {
            Assert.IsNotNull(YieldCache.WaitForEndOfFrame);
        ...
        {
            Assert.IsNotNull(YieldCache.WaitForFixedUpdate);
